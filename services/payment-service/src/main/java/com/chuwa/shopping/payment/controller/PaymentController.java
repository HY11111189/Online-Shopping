...
public class PaymentController {
    ...
    public ResponseEntity<PaymentDto> cancelPayment(@PathVariable String paymentNumber,
                                                    @RequestBody RefundRequestDto requestDto) {
        return ResponseEntity.ok(paymentService.cancelPayment(paymentNumber, requestDto));
    }
