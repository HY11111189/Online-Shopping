        ...
        <div className="stack">
          ...
          <div className="buy-box-card">
            ...
            <div className="buy-box-purchase-row">
              ...
              >
                <svg viewBox="0 0 24 24" fill={wishlist.includes(item?.sku) ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="17" height="17" aria-hidden="true">
                  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                </svg>
                <span>{wishlist.includes(item?.sku) ? 'Added to list' : 'Add to list'}</span>
              </button>
            </div>
