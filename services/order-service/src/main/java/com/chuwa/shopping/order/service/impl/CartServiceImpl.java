...
public class CartServiceImpl implements CartService {
    ...
    public CartDto getCart(Long customerId) {
        return orderMapper.toCartDto(getOrCreateCart(customerId));
    }
    ...
    public CartDto addItem(Long customerId, CartItemDto itemDto) {
        ...
        return orderMapper.toCartDto(shoppingCartRepository.save(cart));
    }
    ...
    private String normalizeFulfillmentMethod(String fulfillmentMethod) {
        return "PICKUP".equalsIgnoreCase(fulfillmentMethod) ? "PICKUP" : "SHIPPING";
    }

    private String fulfillmentFromItemId(String itemId) {
        if (itemId != null && itemId.endsWith("::PICKUP")) {
            return "PICKUP";
        }
        return "SHIPPING";
    }

    private String composeCartItemId(String sku, String fulfillmentMethod) {
