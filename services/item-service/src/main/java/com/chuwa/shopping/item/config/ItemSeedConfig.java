    ...
    public CommandLineRunner seedItems(ItemRepository itemRepository) {
        return args -> {
            ...
            List.of(
                    ...
                    item("SKU-1006", "123456789017", "Equate Daily Vitamin Gummies", "Equate", "Health & Wellness", "Berry gummy vitamins and daily wellness medicine support for the whole family.", "10.47", "10.47", 0, "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=900&q=80", Map.of("type", "Gummies"), 72),
                    ...
                    item("SKU-1027", "123456789038", "Nature Made Vitamin C Tablets", "Nature Made", "Health & Wellness", "Daily vitamin C supplement and immune support medicine for everyday health routines.", "12.98", "15.98", 0, "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=900&q=80", Map.of("count", "100"), 104),
                    item("SKU-1028", "123456789039", "TheraBreath Mouthwash", "TheraBreath", "Health & Wellness", "Alcohol-free mouthwash for oral health care and medicine cabinet essentials.", "9.97", "12.97", 0, "https://images.unsplash.com/photo-1556228578-8c89e6adf883?auto=format&fit=crop&w=900&q=80", Map.of("type", "Oral care"), 58),
                    item("SKU-1029", "123456789040", "Band-Aid Adhesive Bandages", "Band-Aid", "Health & Wellness", "Assorted first-aid bandages for cuts, scrapes, and medicine cabinet refills.", "4.48", "5.48", 0, "https://images.unsplash.com/photo-1583947215259-38e31be8751f?auto=format&fit=crop&w=900&q=80", Map.of("count", "100"), 132),
                    item("SKU-1030", "123456789041", "Vicks Thermometer", "Vicks", "Health & Wellness", "Digital thermometer for quick temperature checks and home medicine care.", "14.97", "19.97", 0, "https://images.unsplash.com/photo-1580281657527-47f249e8f7e6?auto=format&fit=crop&w=900&q=80", Map.of("type", "Digital"), 41),
                    item("SKU-1030A", "1234567890411", "Equate Cold & Flu Relief Caplets", "Equate", "Health & Wellness", "Multi-symptom cold and flu medicine caplets for cough, fever, and congestion relief.", "8.94", "10.94", 0, "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=900&q=80", Map.of("type", "Cold medicine"), 76),
