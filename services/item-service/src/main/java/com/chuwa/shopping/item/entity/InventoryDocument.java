...
public class InventoryDocument {
    ...
    @Field("processed_operation_ids")
    private List<String> processedOperationIds = new ArrayList<>();
    ...
    public List<String> getProcessedOperationIds() {
        return processedOperationIds;
    }

    public void setProcessedOperationIds(List<String> processedOperationIds) {
        this.processedOperationIds = processedOperationIds;
    }
}
