...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountDto createAccount(AccountRequestDto requestDto) {
        ...
        return shoppingMapper.toAccountDto(customerAccountRepository.save(account));
    }
    ...
    public AccountDto getAccount(Long accountId) {
        return shoppingMapper.toAccountDto(getAccountEntity(accountId));
    }

    @Override
    @Transactional(readOnly = true)
    public AccountDto getAccountByUsername(String username) {
        return shoppingMapper.toAccountDto(customerAccountRepository.findByUsername(username)
    ...
    public AccountDto getAccountByIdentity(String identity) {
        ...
        return shoppingMapper.toAccountDto(account);
    }
